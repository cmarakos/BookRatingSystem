-- Insert reviews for book ID 84
INSERT INTO review (book_id, rating, review_text)
VALUES (84, 5, 'An outstanding book!'),
       (84, 4, 'Very well written.'),
       (84, 5, 'A masterpiece of literature.');

-- Insert reviews for book ID 2701
INSERT INTO review (book_id, rating, review_text)
VALUES (2701, 4, 'A great adventure story.'),
       (2701, 3, 'Good, but not my favorite.'),
       (2701, 4, 'Well worth the read.');

-- Insert reviews for book ID 1513
INSERT INTO review (book_id, rating, review_text)
